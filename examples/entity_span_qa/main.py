...
from .utils import HIGHLIGHT_TOKEN, PLACEHOLDER_TOKEN, ENTITY_MARKER_TOKEN, RecordProcessor,\
...
def run(common_args, **task_args):
    ...
    args.model_weights['embeddings.word_embeddings.weight'] = torch.cat([word_emb, highlight_emb, placeholder_emb,
                                                                         marker_emb])
