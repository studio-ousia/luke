...
def run_pretraining(args):
    ...
    if args.multilingual:
        batch_generator = MultilingualBatchGenerator(dataset_dir_list, dataset.data_size_list,
                                                     args.sampling_smoothing,
                                                     train_batch_size, args.masked_lm_prob,
    ...
    optimizer = LukeDenseSparseAdam(optimizer_parameters, lr=args.learning_rate, betas=(args.adam_b1, args.adam_b2),
                                    eps=args.adam_eps, grad_avg_device=grad_avg_device)
